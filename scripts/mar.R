...
## Write to file without rownames or colnames
...
## CONTINUE HERE - arrange meta_sub by site names

# Run MAR pipeline ----
geno_file = "/global/scratch/projects/fc_moilab/aphillips/spectral_aspen/data/updog/mar.genomat.pos.tsv"

MARPIPELINE(name = "example", 
            workdir = "./", 
            genofile = geno_file, 
            lonlatfile = "lonlat.csv", saveobj = TRUE)